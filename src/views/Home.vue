...
export default {
  ...
  methods: {
    scrollToProjects() {
      ...
      }, 100); // Wait for Vue Router to navigate before scrolling
    }
  },
  mounted() {
    window.scrollTo(0, 0);
    // Set a timeout to gradually show the content after a slight delay
    setTimeout(() => {
...
.show-content {
  opacity: 1;
  background-color: transparent; /* Change to transparent when fully visible */
}
.highlight {
  color: #ffa751;
}
